...
public class ItemDetailActivity1 extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toolbar toolbar = (Toolbar) findViewById(R.id.detail_toolbar1);
        ...
        fab.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View viiew) {
                ...
                Toast.makeText(ItemDetailActivity1.this, "Screenshot has been taken sucessfully", Toast.LENGTH_LONG).show();
            }
        });
