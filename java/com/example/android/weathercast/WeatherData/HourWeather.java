...
public class HourWeather{private String mTimeZone;
    private String mIcon;
    private long mTime;
    private double mTemperature, mHumidity, mPrecipChance, mPressure, mOzone, mWindSpeed;
    ...
    public int getIconId() {
        ...
        if (mIcon.equals( mSummary.equals("Clear")))
            iconId = R.drawable.clear_day;
        else if ( mSummary.equals("Overcast"))
            iconId = R.drawable.overcast;
        else if (mIcon.equals("clear-night"))
            iconId = R.drawable.clear_night;
        else if (mSummary.equals("Drizzle"))
            iconId = R.drawable.drizzle;
        else if ( mSummary.equals("Mostly Cloudy"))
            iconId = R.drawable.mostly_cloudy;
        else if (( mSummary.equals("Rain")))
            iconId = R.drawable.rain;
        else if (mSummary.equals("Light Rain"))
            iconId = R.drawable.light_rain;
        ...
        else if (mIcon.equals("partly-cloudy-day")&& mSummary.equals("Partly Cloudy"))
